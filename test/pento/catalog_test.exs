defmodule Pento.CatalogTest do
  ...
  describe "products" do
    ...
    @valid_attrs %{" description": "some  description", name: "some name", skua: 42, unit_price: 120.5}
    @update_attrs %{" description": "some updated  description", name: "some updated name", skua: 43, unit_price: 456.7}
    @invalid_attrs %{" description": nil, name: nil, skua: nil, unit_price: nil}
